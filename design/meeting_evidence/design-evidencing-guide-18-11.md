...
- [ ] Meeting held on [18/11]
- [ ] Persona discussed: [John Park]
- [x] Design artefacts reviewed: [initial prototype] 4349c7d2f50b42c7954c3aef840ce841f1e5fd26
- [x] Issues discussed: [copy text from output area]
- [ ] Feedback provided: [good. great even]

##### What worked well

- [ minimal layout good, not much confusion html good choice] [list of things that worked well]
...
Topics: 
- nail down assessment requirements. 
